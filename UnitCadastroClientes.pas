...
uses
   ActiveX, System.SysUtils, IdText, IdAttachmentFile;
{$R *.fmx}
...
begin
  ...
  if (EDIT_cpf.Text = '') or (EDIT_cpf.Text.Length < 11) then
  begin
...
begin
  ...
  begin
    showmessage('Não foi possível prosseguir com o cadsatro do cliente. Favor'
